 ...
 * reported as an annotation so the report carries it without failing the
 * run. The suite is green today: a new serious/critical violation is a
 * regression, not an unfinished page.
 *
